...
```{r sumByMonthParis, solution = TRUE}
...
Dans le logiciel *R* il existe plusieurs modules pour la représentation cartographique comme *ggmap*, *maps*
...
FrMap <- st_read(dsn="departements-2017/.",  layer="DEPARTEMENT", quiet = TRUE)
...
```{r sans ultra-marin, solution = TRUE}
ultra_marin <- grep("^97", incidence_mars2021$code_insee)
incidence_mars2021_metro <- incidence_mars2021[- ultra_marin, ]
mf_map(x = incidence_mars2021_metro, var = "incidence", type = "choro")
