...
Lorsque vous importez des données dans R, vous pouvez aussi utiliser des *packages* développés pour le *Data Profiling* ou *l'analyse exploratoire (EDA)* qui proposent des fonctions pour la caractérisation et le contrôle qualité des données. 
...
# Juste pour l'example ici nous remplacons les 0 par des NA
